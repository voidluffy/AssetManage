#ifndef HOMEDYNAMICBUTTONWIDGET_H
#define HOMEDYNAMICBUTTONWIDGET_H
#include <QWidget>
class QLabel;
class DynamicButton;

class HomeDynamicButtonWidget: public QWidget
{
    Q_OBJECT
    //自定义属性，用于样式表
...
public:
    explicit HomeDynamicButtonWidget(QWidget *parent = 0);
...
#endif // HOMEDYNAMICBUTTONWIDGET_H
