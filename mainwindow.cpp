...
//    m_topWidget = new MainTopWidget(this);
    m_bottomWidget = new MainCenterChildWidget(this);




    m_pLookupassetwidget = new LookupAssetWidget;
    m_stackWidget->addWidget(m_pLookupassetwidget);
    m_pAsignassetwidget = new AsignAssetWidget;
    m_stackWidget->addWidget(m_pAsignassetwidget);
    m_pPermissionAsignwidget = new PermissionAsignWidget;
    m_stackWidget->addWidget(m_pPermissionAsignwidget);
}
